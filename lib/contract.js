...
export const CONTRACT_ABI = [
  "function mintMyNFT(uint8 _charity, uint256 _goalAmount) external",
  ...
  "function influencers(uint256) external view returns (uint8 charity, uint256 totalDonations, uint256 goalAmount, bool active, address creator)",
